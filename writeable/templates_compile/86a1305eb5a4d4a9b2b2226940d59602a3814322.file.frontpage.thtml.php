<?php /* Smarty version Smarty-3.0.6, created on 2018-07-22 20:38:17
         compiled from "/Users/dejunliu/Desktop/Develop/php-projects/heroframework/themes/electric/frontpage.thtml" */ ?>
<?php /*%%SmartyHeaderCode:9504605245b547ab9b63019-55113412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86a1305eb5a4d4a9b2b2226940d59602a3814322' => 
    array (
      0 => '/Users/dejunliu/Desktop/Develop/php-projects/heroframework/themes/electric/frontpage.thtml',
      1 => 1345503378,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9504605245b547ab9b63019-55113412',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_block_restricted')) include '/Users/dejunliu/Desktop/Develop/php-projects/heroframework/themes/_plugins/block.restricted.php';
...
"><?php echo $_smarty_tpl->getVariable('post')->value['title'];?>
	 ...
	 <ul class="blog">
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('content', array('var'=>"post",'type'=>"blog",'limit'=>"4",'sort'=>"content.content_date",'sort_dir'=>"desc",'language_id'=>($_smarty_tpl->getVariable('current_language_id')->value))); $_block_repeat=true; smarty_block_content(array('var'=>"post",'type'=>"blog",'limit'=>"4",'sort'=>"content.content_date",'sort_dir'=>"desc",'language_id'=>($_smarty_tpl->getVariable('current_language_id')->value)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
?>
		...
		<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_content(array('var'=>"post",'type'=>"blog",'limit'=>"4",'sort'=>"content.content_date",'sort_dir'=>"desc",'language_id'=>($_smarty_tpl->getVariable('current_language_id')->value)), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
