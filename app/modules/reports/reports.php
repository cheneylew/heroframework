...
class Reports_module extends Module {
	...
	*/
	function admin_preload ()
	{
		...
		$this->CI->admin_navigation->child_link('reports',70,'注册用户',site_url('admincp/reports/registrations'));
		$this->CI->admin_navigation->child_link('reports',80,'流行文章',site_url('admincp/reports/popular'));
