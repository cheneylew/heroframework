...
class Gallery_fieldtype extends Fieldtype {
	/**
	* Constructor
	*
	...
	*/
	function __construct () {
		...
		$this->enabled = TRUE;
		$this->fieldtype_name = 'Gallery';
		$this->fieldtype_description = 'Gallery';
	...
	*/
	function output_admin () {
		...
		$return .= "<input type='button' class='button' onclick='openKCFinderImage(\"".$this->name."\", \"".$this->data["multi_files"]."\")' value='Upload & select'/>";
		$return .= "<ul id='".$this->name."' class='upload_gallery'>";

		if(is_array($this->value)){
			foreach($this->value as $val){
				$return .= "<li><input name='".$this->name."[]' type='hidden' value='".$val."'/><a href='".$val."' target='_blank'><img src='".$val."'/></a><br/>(<a onclick='deleteUploadImage(this)' class='button'>Delete</a>)</li>";
			}
		}

		$return .= "</ul>";
		$return .= '<div class="help" style="clear:both;">'.$this->help.'</div>';
