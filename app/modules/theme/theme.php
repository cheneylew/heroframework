...
class Theme extends Module {
	...
	*/
	...
	{
		$this->CI->admin_navigation->child_link('design',10,'主题编辑器',site_url('admincp/theme/editor'));
		$this->CI->admin_navigation->child_link('design',1,'主题',site_url('admincp/theme'));
	}
