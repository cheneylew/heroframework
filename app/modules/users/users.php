...
class Users_module extends Module {
	...
	*/
	...
	{
		$this->CI->admin_navigation->child_link('members',10,'管理用户',site_url('admincp/users'));
		$this->CI->admin_navigation->child_link('members',20,'添加用户/管理员',site_url('admincp/users/add'));
		$this->CI->admin_navigation->child_link('members',30,'登陆历史',site_url('admincp/users/logins'));
		$this->CI->admin_navigation->child_link('members',40,'用户组',site_url('admincp/users/groups'));
	}
