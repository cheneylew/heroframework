...
class Admincp extends Admincp_Controller {
	...
	function index () {
		...
		$form->value_row('&nbsp;','<div style="float:left; width: 600px">Enter your Google分析 site id (e.g., UA-1234567-1) to automatically
		begin sending site analytics information to your Google分析 account.</div>');
	...
	function post_configure () {
		...
		$this->notices->SetNotice('Google分析 configuration saved successfully.');
