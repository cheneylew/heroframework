...
class Emails extends Module {
	...
	*/
	...
	{
		$this->CI->admin_navigation->child_link('configuration',20,'邮件',site_url('admincp/emails'));
		
		$this->CI->admin_navigation->child_link('members',25,'发送邮件',site_url('admincp/emails/send'));
	}
