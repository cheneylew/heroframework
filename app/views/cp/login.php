...
<body>
	...
	<div id="login_form">
		<h1><span class="app_name"><?=setting('site_name');?></span> | 控制台</h1>
		<form class="validate" method="post" action="<?=site_url('/admincp/login/go');?>">
			<ul class="form">
				...
				<li class="submit">
					<input type="submit" class="button" name="login_button" class="button" value="登录" />
				</li>
			</ul>
		</form>
		<div class="links">
			<ul class="links">
				<li><a href="<?=site_url();?>">访问网站</a></li>
				<li><a href="<?=site_url('users/forgot_password');?>">忘记密码</a></li>
				<li><a href="<?=setting('app_support');?>"><?=setting('app_name');?> 技术支持</a></li>
			</ul>
		</div>
	</div>
	<div id="copyright">
		版权所有@ <a href="<?=setting('app_link');?>"><?=setting('app_name');?></a>.
	</div>
</body>
</html>