...
<form class="form" method="post" action="">
	<fieldset>
		...
		<ol>
			...
			<li>
				<label for="username" class="full">用户名</label>
			</li>
			<li>
