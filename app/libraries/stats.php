...
class Stats {
	...
	* @return float 
	*/
	public function revenue ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
	...
	* @return float 
	*/
	public function revenue_by_day ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function orders ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function orders_by_day ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function subscriptions ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function subscriptions_by_day ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function registrations ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function registrations_by_day ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function logins ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
	...
	* @return int 
	*/
	public function logins_by_day ($date_start = '24 小时前', $date_end = FALSE) {
		if ($date_end === FALSE) {
			$date_end = date('Y-m-d H:i:s');
		}
