...
|
*/
$config['base_url'] = "http://heroframework.com/";
...
|
*/
$config['encryption_key'] = "fa82787dbbbf51ffed0d5f9706483850";
$config['cron_key'] = '4f3965641dabf41da348f9060e8b71bb';
...
|--------------------------------------------------------------------------
|
| This determines the website language files. Make sure
| there is an available translation if you intend to use something other
| than english.
|
*/
$config["language_list"][] = array("language_id"=>"3","language_code"=>"sc","language_name"=>"简体中文");
$config["language_list"][] = array("language_id"=>"1","language_code"=>"en","language_name"=>"English");
$config["language_list"][] = array("language_id"=>"2","language_code"=>"tc","language_name"=>"繁体中文");
